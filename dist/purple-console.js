...
(function () {
    ...
    var ajsrConsole = function (options, e) {
        ...
        var delayedAttachHtmlByTimestamp = function (str) {
            ...
            if (
                currentPrintAtemptTiemstamp >
                previousPrintAtemptTiemstamp + printAtemptTimeBoundary
            ) {
                el.innerHTML = printAtemptBuffer + str;
                printAtemptBuffer = "";
        ...
        var printObj = function (o, borderColor, backgroundColor) {
            ...
            if (lon > MAX_LEN) {
                write(
                    "<b>Sorry, this object has more than " +
                    MAX_LEN +
                    " properties. </b>Please use 'setMaxObjLength()' to print bigger objets",
                    "red"
                );
                return;
            }
            str =
                '<div style="padding:2px 5px;border:1px solid ' +
                borderColor +
                "; background-color: " +
                backgroundColor +
                '">';
        ...
        var hide = function () {
            document
                .getElementById("ajsrConsole-container")
        ...
        if (document.body != null) {
            ...
            console.log(
                "[ajsrConsole] purple-console code was imported in <HEAD>. Let's wait to document creation"
            );
